...
public class MasterControlTest {
    ...
    @Test
    void second_sample_system_behavior_check() {
        input.add("Create savings 12345678 0.6");
        input.add("Deposit 12345678 700");
        input.add("Deposit 12345678 5000");
        ...
        input.add("creAte cHecKing 98765432 0.01");
        input.add("Deposit 98765432 300");
        input.add("Transfe 98765432 12345678 300");
        input.add("Transfer 98765432 12345678 300");
        input.add("Pass -3");
        input.add("Pass 1");
        ...
        assertEquals("Savings 12345678 200.50 0.60", actual.get(0));
        assertEquals("Deposit 12345678 700", actual.get(1));
        assertEquals("Transfer 98765432 12345678 300", actual.get(2));
        ...
        assertEquals("Transfe 98765432 12345678 300", actual.get(7));
        assertEquals("Pass -3", actual.get(8));
    }
    ...
    void system_with_only_invalid_commands_once_final_account_closes() {
        ...
        assertEquals(1, actual.size());
        assertEquals("depost 12345678 800", actual.get(0));
    }
}
